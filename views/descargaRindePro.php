      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-footer">
                  <a href ="http://oficina.prosud.cl/rindepro/rindepro.apk" class="btn btn-success btn-lg">Descargar Aqui</a>
                </div>
              </div>
            </li>
            <!-- END timeline item -->
            <!-- timeline item -->
            <li>
              <i class="fa fa-download bg-aqua"></i>

              <div class="timeline-item">
                <span class="time"><i class="fa  fa-download"></i> Segundo Paso</span>
            ...
            <!-- timeline item -->
            <li>
              <i class="fa fa-download bg-purple"></i>

              <div class="timeline-item">
                <span class="time"><i class="fa fa-download"></i> Tercer Paso</span>
            ...
            <li>
              ...
              <div class="timeline-item">
                <span class="time"><i class="fa fa-download"></i> Paso Final</span>

                <h3 class="timeline-header"><a href="#">Aplicacion Instalada </a> Al terminar la instalacion te dara la opcion de abrir la aplicacion y te pedira permisos de algunas funciones del telefono.</h3>

                <div class="timeline-body">
                  <img src="http://oficina.prosud.cl/rindepro/6.jpg" width="30%" alt="..." class="margin">
                  <img src="http://oficina.prosud.cl/rindepro/7.jpg" width="30%" alt="..." class="margin">
                  <img src="http://oficina.prosud.cl/rindepro/8.jpg" width="30%" alt="..." class="margin">
                </div>
                <div class="timeline-footer">
                </div>
              </div>
