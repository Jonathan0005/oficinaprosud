...
<head>
  ...
  <title>Intranet Prosud | Generador Firma</title>
...
<hr class="mt-5 mb-5">
        ...
        <!-- <img src="img/imgGeneradorCorreo/instr.png" width="270" height="150" style="border-width:5px; border-style:double;"> -->
        <!-- <p></p> -->
  
</div>

<hr class="mt-5 mb-5">
<div  style=" margin:auto; background-color: white; border-radius: 0px; height: 270px;  width: 469px;padding: 20px; border-style: dotted; color: #062244;">
        <table  style="cellspacing:0; padding:0px; empty-cells:hide;  border-collapse: separate;" >
          <tr > 
            <td><img src="img/imgGeneradorCorreo/logo6.png" style="width:126px; height:125px;">
            </td>
...
<td align="left" style="width:270px;" >
      ...
      <strong id="nombrefirma" style="font-family: calibri;">[[nombre  || "Nombre Completo"]]</strong><br>
        ...
        <span style="font-family: calibri;">Lautaro 2102-D, Quilicura</span>
            ...
            <a href ="httP://prosudmarket.cl"><img src="img/imgGeneradorCorreo/firma2.png" width="419px" height="107px"></td></a>
          </tr>
        </table>
